...
<head>
  ...
  <title>Super Admin: Prarang</title>
  ...
  <style>
    /* App brand text */
#layout-menu .demo .app-brand-text{
        ...
        <div class="app-brand demo">
          <a href="index.html" class="app-brand-link">
            <span class="app-brand-logo demo">
              <img src="https://b2b.prarang.in/assets/images/logo-icon.png" width="30" alt="">
            </span>
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Prarang</span>
          </a>
